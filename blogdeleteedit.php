...
if(isset($_POST['delete']))
{
	...
	$ain=$nr["authorID"];
	mysqli_query($con,"INSERT INTO `bloggernotification`(bloggerID,suba,type,subb,seen) VALUES($ain,'Admin',1,'$tn',0)");
...
<form action="editblog01.php" enctype="multipart/form-data" method="post">
