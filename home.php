...
$con=mysqli_connect("127.0.0.1","root","")or
	...
	$tags='';
	$result=mysqli_query($con,"SELECT * FROM blogger WHERE 1");
	...
	$result1=mysqli_query($con,"SELECT * FROM blogs WHERE 1");
...
<form autocomplete="off" action="searchresult.php" target="target1" method="POST">
  <center><input id="myInput" type="text" name="sresult" placeholder="Search.."></div><button class="w3-large b1" type="submit">Search</button></center>
</form></center>
<script>
