...
$con=mysqli_connect("127.0.0.1","root","")or
    ...
    mysqli_select_db($con,"blog")or
	   ...
	   if($name!=NULL){
$qry = "INSERT INTO `admin`(name,username,email,password,imagetmp,imagename) VALUES('$name','$username','$email','$password','$imagetmp','$imagename')";
if(mysqli_query($con,$qry))
{
	echo '<script>alert("Successfully signed up!!!");location="loginadmin.php";</script>';
}
else
{
   	echo '<script>alert("Error !! Sorry please sign up again.");location="signupadmin.php";</script>';
}	
}
}
?>
